...
class TextStyles {
  static TextStyle headlineStyle = GoogleFonts.dmSans(
      fontWeight: FontWeight.w800, color: AppColors.secondary, fontSize: 32);
  ...
  static TextStyle filterBottomSheetTitles = GoogleFonts.dmSans(
      fontWeight: FontWeight.w600, color: AppColors.secondary, fontSize: 24);

  static TextStyle listsTitle = GoogleFonts.dmSans(
      fontWeight: FontWeight.w500, color: AppColors.secondary, fontSize: 20);

  static TextStyle accountLabels = GoogleFonts.dmSans(
      color: AppColors.secondary, fontSize: 16, fontWeight: FontWeight.w400);
  ...
  static TextStyle dialogTitleStyle = GoogleFonts.dmSans(
      fontWeight: FontWeight.bold, color: AppColors.secondary, fontSize: 20);
