...
class FilterButton extends StatelessWidget {
  ...
  void _showCategoryDialog(BuildContext context) {
    ...
    showDialog(
      context: context,
      builder: (context) => ReusableFilterDialog<Category>(
  ...
  void _showSubcategoryDialog(BuildContext context, int categoryId) {
    final subcategories = Subcategory.dummySubcategories
        .where((sub) => sub.categoryId == categoryId)
        .toList();

    showDialog(
      context: context,
      builder: (context) => ReusableFilterDialog<Subcategory>(
        title: context.read<FilterCubit>().state.selectedCategory?.name ??
            'Select Subcategory',
        items: subcategories,
