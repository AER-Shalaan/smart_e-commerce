...
import 'package:smart_ecommerce/layouts/home/layouts/product_details/widgets/body_details/product_details/product_name_details_review_price.dart';class ProductDetailsViewBody extends StatelessWidget {
          ...
          return CustomScrollView(
            slivers: [
              ...
              ProductNameDetailsReviewPrice(
                productData: productDetailsModel.data!,
              ),
